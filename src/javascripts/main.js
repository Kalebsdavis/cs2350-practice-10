...
let initial_cards=[
  ...
  function hideForm(){
    ...
    document.querySelector("#my_form").classList.add('d-none')
    document.querySelector("#cards").classList.remove('d-none')
  }
  function hideCards(){

    document.querySelector("#my_form").classList.remove('d-none')
  ...
  document.querySelector("#my_form").onsubmit=addNewCard
